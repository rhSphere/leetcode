...
description:
---
<p class="description">排序算法可以说是一项基本功，解决实际问题中经常遇到，针对实际数据的特点选择合适的排序算法可以使程序获得更高的效率，有时候排序的稳定性还是实际问题中必须考虑的，这篇博客对常见的排序算法进行整理，包括：插入排序、选择排序、冒泡排序、快速排序、堆排序、归并排序、希尔排序、二叉树排序、计数排序、桶排序、基数排序。</p>
...
### :one:[选择排序（Selection Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/selection-sort.html)
...
### :two:[插入排序（Insertion Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/insertion-sort.html)
...
### :three:[希尔排序（Shell Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/shell-sort.html)
...
### :four:[冒泡排序（Bubble Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/bubble-sort.html)
...
### :five:[鸡尾酒排序（Cocktail Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/cock-tail-sort.html)
回顾冒泡排序的思想：
...
### :six:[归并排序（Merge Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/merge-sort.html)
...
### :seven: [快速排序（Quick Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/quick-sort.html)
...
```
### :eight: [计数排序（Count Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/count-sort.html)

如果通过比较进行排序，那么复杂度的下界是O(nlogn)，但是如果数据本身有可以利用的特征，可以不通过比较进行排序，就能使时间复杂度降低到O(n)。

计数排序要求待排序的数组元素都是 整数，有很多地方都要求是0-K的正整数，其实负整数也可以通过都加一个偏移量解决的。
...
### :nine: [桶排序（Bucket Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/bucket-sort.html)
...
### :ten: [堆排序（Heap Sort）](https://blogs.rhsphere.com/leetcode/2019/04/01/heapsort-easy.html)
